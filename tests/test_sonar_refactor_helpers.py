"""Targeted tests for the helpers extracted during the Sonar S3776 refactor
sweep. These keep the new helper functions exercised so the new-code
coverage stays above the quality-gate threshold."""
